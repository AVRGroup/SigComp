 ...
 */
class Turma extends \App\Model\Turma implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'codigo', 'disciplina', 'avaliacoes', 'turmas_professor', 'respostas_avaliacao'];
        }
