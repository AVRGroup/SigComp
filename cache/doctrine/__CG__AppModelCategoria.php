 ...
 */
class Categoria extends \App\Model\Categoria implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'nome', 'descricao', 'categoria_topicos'];
        }
    ...
    public function getTopicos()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getTopicos', []);

        return parent::getTopicos();
    }
