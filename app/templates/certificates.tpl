...
{block name=content}
    ...
    <form method="post" enctype="multipart/form-data">
        <div class="custom-file col-sm-12 col-md-8 col-xs-12 col-lg-8">
        ...
        <div style="margin-top: 3%; padding: 10px" class="form-row">
            ...
            <input type="number" class="form-control col-sm-12 col-md-6 col-xs-12 col-lg-6" name="num_horas" required placeholder="De quantas horas é esse certificado?">
        </div>


        <label style="margin-top: 3%" for="data-inicio">Digite a data de inicio do certificado</label>
        <input type="date" id="data-inicio" name="data_inicio" class="form-control col-sm-8 col-md-8 col-xs-8" required>

        <label style="margin-top: 2%" for="data-fim">Digite a data de término do certificado</label>
        <input type="date" id="data-fim" name="data_fim" class="form-control col-sm-8 col-md-8 col-xs-8" required>
    ...
    <div class="text-center" style="margin-bottom: 20px">
        ...
        <form action="{path_for name="mergepdfs"}" method="post" enctype="multipart/form-data" name="form1" id="form1">
            ...
            <button style="margin-top: 1%" class="btn btn-primary" type="submit">Baixar Comprovantes (.zip)</button>
        </form>
    </div>
