...
{block name=content}
    ...
    <form method="post">
        <div class="form-row">
            <div class="col-md-6 col-sm-11 mx-sm-auto mx-md-0 mt-sm-4 mt-md-3">
            ...
            <div class="custom-control custom-checkbox mt-md-5 mt-sm-3 ml-sm-5 ml-md-0 ">
        ...
        <div class="form-row" style="margin-top: 3%">
            ...
            <div class="col-md-6 col-sm-11 mt-sm-3 mt-md-0 mx-sm-auto">
