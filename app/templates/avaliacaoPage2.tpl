  ...
  <hr>
      <nav aria-label="navigation">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="{path_for name="avaliacaoPage01"}?disciplina={$parametro}" aria-label="Anterior">
          ...
          <li class="page-item">
            <a class="page-link" href="{path_for name="avaliacaoPage03"}?disciplina={$parametro}" aria-label="Próximo">
