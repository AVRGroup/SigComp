    ...
    <div style="margin-bottom: 3%">
      {foreach $questoes as $questao}
          ...
          <div style=" font-size: 20px">
            <form method="POST" action="{base_url}/store-avaliacao-2">          <!-- Começa o formulario -->
              ...
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio1" name="customRadio02" class="custom-control-input">
                <label class="custom-control-label" for="radio1">1</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio2" name="customRadio02" class="custom-control-input">
                <label class="custom-control-label" for="radio2">2</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio3" name="customRadio02" class="custom-control-input">
                <label class="custom-control-label" for="radio3">3</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio4" name="customRadio02" class="custom-control-input">
                <label class="custom-control-label" for="radio4">4</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio5" name="customRadio02" class="custom-control-input">
        ...
        {if $questao->getTipo()==1}
          <div style=" font-size: 20px">
          <form method="POST" action="{base_url}/store-avaliacao-2">
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" value="radio1" name="customRadio02" class="custom-control-input">
  ...
  <hr>
      <nav aria-label="navigation">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="{path_for name="store-avaliacao-1"}?disciplina={$parametro}" aria-label="Anterior">
          ...
          <li class="page-item">
            <a class="page-link" href="{path_for name="store-avaliacao-3"}?disciplina={$parametro}" aria-label="Próximo">
