...
<h2 class="text-center"> Avaliação </h2>
  ...
  <div style="margin-left:10%; margin-bottom: 10% ">           <!-- DIV PRINCIPAL -->
      ...
      {foreach $questoes as $questao}
        ...
        {if $questao->getTipo()==0}
          <div style=" font-size: 20px">
            <form method="POST" action="{base_url}/store-avaliacao-3">        <!-- Começa o fomulario -->

              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio1" name="customRadio03" class="custom-control-input">
                <label class="custom-control-label" for="radio1">1</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio2" name="customRadio03" class="custom-control-input">
                <label class="custom-control-label" for="radio2">2</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio3" name="customRadio03" class="custom-control-input">
                <label class="custom-control-label" for="radio3">3</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio4" name="customRadio03" class="custom-control-input">
                <label class="custom-control-label" for="radio4">4</label>
              </div>
              <div class="custom-control custom-radio custom-control-inline">
                <input type="radio" value="radio5" name="customRadio03" class="custom-control-input">
        ...
        {if $questao->getTipo()==1}
          <div style=" font-size: 20px">
          <form method="POST" action="{base_url}/store-avaliacao-3">
            <div class="custom-control custom-radio custom-control-inline">
              <input type="radio" value="radio1" name="customRadio03" class="custom-control-input">
    ...
    <div class="text-sm-center" >
        <button class="btn btn-primary btn-lg btn-block" href="{path_for name="Enviar"}?disciplina={$parametro}" style="margin-bottom: 1%" type="submit">Enviar </button>
    </div>
    <hr>
      <nav aria-label="navigation">
        <ul class="pagination justify-content-center">
          <li class="page-item">
            <a class="page-link" href="{path_for name="store-avaliacao-2"}?disciplina={$parametro}" aria-label="Anterior">
